...
| `_vwo_sn`                                     | This VWO cookie stores session-level information                                                                                                                                                                                                         | 30 mins and reset again to 30 mins on activity  |
...
| `_vwo_referrer`                               | This cookie stores referral info allowing VWO to identify the original traffic source in case of the split URL campaign                                                                                                                                  | 15 secs                                         |
...
| `CLID`                                              | Identifies the first-time Clarity saw this user on any site using Clarity                                                                                      | 13 months                                                  |
| `ANONCHK`                                           | Indicates whether MUID is transferred to ANID, a cookie used for advertising                                                                                   | 13 months                                                  |
| `MR`                                                | Indicates whether to refresh MUID                                                                                                                              | 13 months                                                  |
...
| `SM`                                                | Used in synchronising the MUID across Microsoft domains                                                                                                        | 13 months                                                  |
...
| `_scid`              | Used by Snapchat for tracking your actions, such as selecting recommended adverts. This information is used to make adverts more meaningful and relevant to you       | 12 months              |
| `_gac_UA-179982899-1`| Records how you’ve interacted with advertising campaigns                                                                                                              | 90 days                |
