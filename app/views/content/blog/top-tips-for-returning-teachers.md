...
If you have [qualified teacher status (QTS)](https://www.gov.uk/guidance/qualified-teacher-status-qts) and want to return to teach chemistry, computing, maths, modern foreign languages or physics, you're eligible for a [Return to Teaching Adviser](https://adviser-getintoteaching.education.gov.uk/) (RTTA). You can get personalised guidance and support from an experienced teaching professional.
...
[Find out more about returning to teaching](/returning-to-teaching). If you have qualified teacher status (QTS) and want to return to teach chemistry, computing, maths, modern foreign languages or physics, [get a return to teaching adviser](https://adviser-getintoteaching.education.gov.uk/).
