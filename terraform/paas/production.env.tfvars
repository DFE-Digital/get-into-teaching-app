...
paas_linked_services         = ["get-into-teaching-prod-redis-svc", "get-into-teaching-app-prod-pg-git-svc"]
...
paas_database_git_name       = "get-into-teaching-app-prod-pg-git-svc"
instances                    = 6
basic_auth                   = 0
