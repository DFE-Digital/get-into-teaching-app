...
describe Content::AdviserComponent, type: :component do
  subject(:render) do
  ...
  it { is_expected.to have_link("privacy notice (opens in new tab)", href: "/privacy-policy?id=4872c8ed-0229-f111-8342-7c1e5285e3ab") }
