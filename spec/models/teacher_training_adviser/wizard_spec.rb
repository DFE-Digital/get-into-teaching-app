  ...
  describe ".steps" do
    ...
    it do
      expect(subject).to eql [
        ...
        # TeacherTrainingAdviser::Steps::PaidTeachingExperienceInUk,
        # TeacherTrainingAdviser::Steps::TrainToTeachInUk,
        TeacherTrainingAdviser::Steps::NotEligible,
        # TeacherTrainingAdviser::Steps::StageTrained,
        ...
        TeacherTrainingAdviser::Steps::NotEligible2,
