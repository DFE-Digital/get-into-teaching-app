...
RSpec.feature "Event wizard", type: :feature do
  ...
  scenario "Full journey as a walk-in candidate (closed event), no accessibility needs" do
    ...
    expect(page).to have_text "When you're at the event, will you need any extra support that's not listed on this page?"
    choose "No"
    click_on "Next step"
  ...
  scenario "Full journey as a walk-in candidate, skipping verification, with accessibility needs" do
    ...
    fill_in "Tell us about the extra accessibility support you need at the event", with: "This is some test accessibility needs text"
    click_on "Next step"
