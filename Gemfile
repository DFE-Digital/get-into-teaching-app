...
gem "get_into_teaching_api_client_faraday", ">= 3.6.0", github: "DFE-Digital/get-into-teaching-api-ruby-client", require: "api/client", branch: "add-creation-channel-to-tta"
