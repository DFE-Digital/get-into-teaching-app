...
gem "connection_pool"
gem "get_into_teaching_api_client_faraday", ">= 3.1.3", github: "DFE-Digital/get-into-teaching-api-ruby-client", require: "api/client", branch: 'add-creation-channel-to-tta', ref: 'f7b8dfc3113a911de616cea63f84770214bcb76b'
gem "redis"
