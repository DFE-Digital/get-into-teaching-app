...
SecureHeaders::Configuration.override(:chat) do |config|
  webchat = %w[*.niceincontact.com ws: wss: ye3ijnvr9l.execute-api.eu-west-2.amazonaws.com/Production tpdfe.satmetrix.com/npxapi/conversation/v1.0/reply tpdfe.satmetrix.com/npxapi/conversation/v1.0/initiate tpdfe.satmetrix.com/npxapi/outcast/v1.0/survey/rules]
