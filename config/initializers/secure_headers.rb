...
SecureHeaders::Configuration.default do |config|
  ...
  config.csp = {
    ...
    img_src: %w['self' linkbam.uk *.gov.uk data: *.googleapis.com www.facebook.com ct.pinterest.com t.co www.facebook.com cx.atdmt.com *.visualwebsiteoptimizer.com ad.doubleclick.net i.ytimg.com] + google_analytics,
    manifest_src: %w['self'],
    media_src: %w['self'],
